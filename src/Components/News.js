...
export class News extends Component {
  ...
  async componentDidMount(){
    ...
    let url = "https://newsapi.org/v2/top-headlines?country=in&apiKey=21159e9c23394e4cb926042ccfb51949&page=1&pageSize=19";
    ...
    this.setState({
      ...
      // isNextButtonDisabled: page>= Math.ceil(parsedData.totalResults/19)
    });
  }


  handlePrevClick = async ()=>{
    let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=21159e9c23394e4cb926042ccfb51949&page=${this.state.page - 1}&pageSize=19`;
    let data = await fetch(url);
    let parsedData = await data.json();
    // console.log(parsedData)
    ...
    return (
      <div className='container my-3'> 
        ...
        <div className="container d-flex justify-content-between">
          ...
          <button disabled={this.state.isNextButtonDisabled} type="button" class="btn btn-dark mx-3" onClick={this.handleNextClick}>Next &rarr;</button>
        </div>
      </div>
    )
  }
